...
class _AudioPlayerControlsState extends State<AudioPlayerControls> {
  ...
  String _getFileName(String? path) {
    if (path == null || path.isEmpty) return 'Unknown Title';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<PlayerBloc, PlayerState>(
      builder: (context, state) {
        ...
        final songTitle = _getFileName(songPath);
        ...
        return GestureDetector(
          ...
          child: Stack(
            ...
            children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        if (isPlaying) {
                          ...
                          context.read<PlayerBloc>().add(PlaySong(songPath!));
                        }
                      },
                    ),
                  ],
              ...
              // Progress Bar with Extended Touch Area
              Positioned(
                top: 0,
                left: 0,
                right: 0,
